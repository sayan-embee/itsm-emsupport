...
namespace BotDialog.Layer.Services
{
    public class AdaptiveCardService
    {
        ...
        public Attachment GenerateRatingCard_Bak(List<WebChatFeedbackOptionsModel> feedbackOptions)
        {
            var cardContent = new
            {
                type = "AdaptiveCard",
                                                ...
                                                card = new
                                                {
                                                    ...
                                                    body = new List<object>
                                                    {
                                                        ...
                                                        new
                                                        {
                                                            ...
                                                            style = "expanded",
                                                            choices = feedbackOptions.Select(option => new
                                                            {
                                                                title = new string('⭐', option.Id),
        ...
        public Attachment CreateCard_LikeDislike_Response_PersonalScope(string message)
        {
            try
            {
