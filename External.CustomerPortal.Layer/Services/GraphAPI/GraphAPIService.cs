...
namespace External.CustomerPortal.Layer.Services.GraphAPI
{
    public class GraphAPIService : IGraphAPIService
    {
        ...
        public GraphAPIService(IConfiguration configuration)
        {
            ...
            clientId = _configuration.GetValue<string>("AppConfig:TEAMS_BOT_ID");
            clientSecret = _configuration.GetValue<string>("AppConfig:TEAMS_BOT_PASSWORD");
            tenantId = _configuration.GetValue<string>("AppConfig:TEAMS_BOT_TENANT_ID");
        }
